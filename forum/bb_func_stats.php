<?php
/*
This file is part of miniBB. miniBB is free discussion forums/message board software, without any warranty. See COPYING file for more details. Copyright (C) 2004-2006, 2011 Paul Puzyrev, Sergei Larionov. www.minibb.com
...
if(!isset($vMax)) $vMax=$val;
if ($vMax!=0) $stats_barWidth=round(100*($val/$vMax));
$fUrl=addForumURLPage(genForumURL($main_url, $forumId, $forumNames[$forumId][0]), PAGE1_OFFSET+1);
