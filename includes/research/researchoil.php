...
include("$directory/includes/misc/include.php");
        ...
        $result = mysql_query("SELECT * FROM resource_cost WHERE id = 10", $db);
        $result3 = mysql_query("SELECT * FROM oil_well WHERE member_id = '$id'", $db);
      ...
      while($research = mysql_fetch_array($result3))
      {
		...
		exit();
                ...
                $start_research = mysql_query("UPDATE oil_well SET isresearch = 1 WHERE member_id = '$id'", $db);
