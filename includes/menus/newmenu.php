...
include("$directory/includes/misc/tick.php");
...
echo "<tr><td><a href=\"/forum/\" target=\"_self\">$menu36</a></td></tr>";
...
//Admin portion of menu
        ...
        while($admin_row = mysql_fetch_array($admin_sql))
                ...
                if($admin_row[25] == 5)
                {
                    ...
                    echo "<tr><td><a href=\"./admin/news.php\">Post News</a><br></td></tr>";
                }
                if($admin_row[25] >= 4)
                {
                    echo "<tr><td><a href=\"./admin/multi.php\">Multihunt</a><br></td></tr>";
                    echo "<tr><td><a href=\"./admin/ttd.php\">TTD Users</a><br></td></tr>";
                    echo "<tr><td><a href=\"./admin/edit.php\">Edit User</a><br></td></tr>";
                    echo "<tr><td><a href=\"./admin/rules.php\">Edit Rules</a><br></td></tr>";
                    echo "<tr><td><a href=\"./admin/bank.php\">Edit Bank</a><br></td></tr>";

                }
                                if($admin_row[25] >= 1)
                {

                    echo "<tr><td><a href=\"./admin/editrogue.php\">Edit Rogues</a></td></tr>";
                }
                }
